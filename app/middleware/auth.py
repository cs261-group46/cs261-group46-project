...
def auth_required(*auth_req_args, required_permission_level=0):
    def decorator(func):
        ...
        def decorated(*args, **kwargs):
            return verify_auth(func, required_permission_level_final, *args, **kwargs) # You probably don't need to separate it into another function, but i wanted to keep the signature
        return decorated
